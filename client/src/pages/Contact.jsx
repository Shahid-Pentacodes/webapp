              ...
              setFormData({ ...formData, name: e.target.value })
                                        ...
                                        <div className="col-xl-6 col-lg-6">
                                            <div className="contact-three__input-box">
                                                ...
                                                />
                                                <input type="text" placeholder="Company" name="inquiry_type"
                                                onChange={(e) =>
                                        ...
                                        <div className="col-xl-12">
                                            <div className="contact-three__input-box text-message-box">
                                                <textarea name="message" placeholder="Messege" onChange={(e) =>
        ...
        <div className="container">
          <div className="cta-one__inner">
            ...
            <p className="cta-one__text">
              ...
              pains
              <br />
              to avoid worse pains to the selection circumstances
            </p>
            <div className="cta-one__btn-and-call-box">
              ...
              <div className="cta-one__call-box">
                ...
                <div className="content">
                  <p>Make a call</p>
                  <h4>
                    <Link href="tel:00554755242">00 55 475 5242</Link>
                  </h4>
                </div>
              </div>
            </div>
